    ...
    <>
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.rowStyle}>
            1. Эцэг /эх/-ийн нэр: _____________________________________________
          </div>
          <div
            style={{
              ...styles.rowStyle,
          ...
          <div style={styles.leftText}>
            Биеийн юм _________________ насандаа ирсэн _______________ хоноод
            ___________ хоног үргэлжилнэ.
          </div>
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            <div style={{ width: 500, marginLeft: 50 }}>
              <div style={styles.leftText}>
                Сүүлийн биеийн юм ирсэн _______ он ______ сар ____ өдөр
              </div>
              <div style={styles.leftText}>
                Жирэмслэхээс /зур/ хамгаалдаг, үгүй
              </div>
              <div style={styles.leftText}>
                Хамгаалдаг арга ____________________________________
              </div>
            </div>
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            Үр хөндүүлсэн удаа _________ Үүнээс гүйцэд төрсөн хүүхэд ________
            зулбасан ________
          </div>
          <div style={styles.leftText}>
            Сүүлийн жирэмслэлт _________ онд Төгсгөл: /зур/ гүйцэд, дутуу
            төрсөн, зулбасан, үр хөндүүлсэн
          </div>
          <div style={styles.leftText}>
      ...
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.leftText}>
            Бодит үзлэг (Амьсгал, зүрх судас, хоол шингээх, шээс бэлгийн
            тогтолцоо)
          </div>
          {[...Array(10)].map((x, i) => (
          ...
          <div style={styles.leftText}>
            Гадна бэлэг эрхтэнг _______________________ уусмалаар
            халдваргүйтгэж, үтрээнд толь тавьж, үтрээ болон умайн
          </div>
          <div style={styles.leftText}>
            хүзүүг ариутгав. Ажилбарын үед өвдөлт намдаалтыг: /зур/ умайн
            хүзүүний орчны эдэд хориг хийх, бүсчилсэн
          </div>
          <div style={styles.leftText}>
            мэдээгүйжүүлэг, ерөнхий мэдээгүйжүүлэг хийв.
          </div>
          <div style={styles.leftText}>
            Мэдээгүйжүүлгийн уусмал, тун хэмжээ:
            ____________________________________________________________
          </div>
          <div style={styles.leftText}>
            Сэтгүүрийг умайн хүзүүгээр болгоомжтой оруулахад умайн байрлал
            _____________, чиглэл_____________, умайн хөндийн
          </div>
          ...
          <div style={styles.leftText}>
            Тийм бол /бичих/: Гигарын тэлэгч № _____________, соруурын хошуу №
            ____________
          </div>
          <div style={styles.leftText}>
            Умайн хөндийн агууламжийг № _______ хошуугаар соруулан, умайн хөндий
            хоосорсон эсэх /зур/: улаан ягаан
          </div>
          <div style={styles.leftText}>
            цусархаг хөөс гарах, хүржигнэх чимээ сонсогдох, соруурт эд дахин орж
            ирээгүй-г шалгаж хавхлагыг хаасны
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            Умайгаас соруурын хошуу, суман хавчуур, үтрээний толийг авч
            ажилбарыг дуусгав
          </div>
          <div style={styles.leftText}>
            Алдсан цус ________ мл. Ажилбарын үргэлжилсэн хугацаа
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 30 }}>Үгүй</span>
            <span style={{ marginLeft: 30 }}>
              Тийм бол бичих: _________________________________________
            </span>
          </div>
          <div style={styles.leftText}>
            __________________________________________________________________________________________________________________________________
          ...
          <div style={styles.leftText}>
            Тийм бол
            /бичих/:______________________________________________________________________
          </div>
          <div style={styles.centerText}>
            Эмчлэгч эмч ____________________________
          </div>
          <div style={styles.centerText}>
            Эмчлэгч эмч ___________ он ________ сар ________ өдөр
          </div>
        </div>
      </div>
    </>
