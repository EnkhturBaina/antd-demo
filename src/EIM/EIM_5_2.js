    ...
    <>
      <div className="page">
        <div className="subpage">
          ...
          <div
            style={{ fontSize: 12, fontStyle: "italic", textAlign: "right" }}
          >
          ...
          <Table bordered className="document" style={{ marginBottom: 0 }}>
            <tbody>
              <tr>
                ...
                <td
                  style={{ ...styles.leftText, ...{ width: "50%" } }}
                  colSpan={3}
                >
                  2. РД
                </td>
              ...
              <tr>
                <td style={styles.topText}>
                  5. Төрсөн ______ он _____ сар _____ өдөр
                </td>
              ...
              <tr>
                <td rowSpan={2} colSpan={2}>
                  ...
                  <div style={styles.leftText}>
                    Сум/дүүрэг: _________________________________
                  </div>
                  <div style={styles.leftText}>
                    Баг/хороо __________________________________
                  </div>
                  <div style={styles.leftText}>
                    Гудамж/Байшин: ___________________________
                  </div>
              ...
              <tr>
                <td style={styles.topText}>
                  12. Урьд нь өрх, сум тосгоны ЭМТ-д илрүүлэг үзлэгт хамрагдсан
                  уу?
                ...
                <td colSpan={3} style={styles.topText}>
                  ...
                  <div style={styles.leftText}>
                    14. Сүүлийн биеийн юм ирсэн эхний өдөр:
                  </div>
              ...
              <tr>
                ...
                <td style={styles.topText}>
                  ...
                  <div style={styles.leftText}>
                     Бэлгийн хавьтлын дараа цус гарах
                  </div>
              ...
              <tr>
                <td colSpan={5} style={styles.leftText}>
                  18. Хүний папиллом вирүсийн вакцин хийлгэсэн эсэх:  тийм 
                  үгүй
                </td>
              </tr>
              <tr>
                <td colSpan={5} style={styles.leftText}>
                  19. Хүний папиллом вирүсийн илрүүлэх шинжилгээ хийлгэсэн эсэх:
                   тийм  үгүй
                </td>
              </tr>
              <tr>
          ...
          <Table bordered className="document" style={{ marginBottom: 0 }}>
            <tbody>
              ...
              <tr>
                ...
                <td style={styles.topText} colSpan={3}>
                  <div style={styles.leftText}>
                     Ур ургацаг харагдана .... цагийн байрлалд ....хэмжээтэй
                  </div>
                  <div style={styles.leftText}>
              ...
              <tr>
                <td style={styles.leftText} colSpan={6}>
                  24. Үтрээний дурангийн шинжилгээ хийсэн үү?  Хийсэн 
                  Хийгээгүй
                </td>
              </tr>
              <tr>
                <td style={styles.leftText} colSpan={6}>
                  25. Хэрэв хийсэн бол үтрээн дурангийн шинжилгээ хийх талаар
                  үйлчлүүлэгчид таниулж зөвшөөрөл авсан эмчийн нэр, гарын үсэг
                  /..................................../.............................................../
                </td>
              </tr>
              <tr>
                <td style={styles.leftText} colSpan={6}>
                  26. Үтрээн дурангийн шинжилгээ хийлгэхийг зөвшөөрсөн
                  үйлчлүүлэгчийн нэр гарын үсэг
                  /......................................./........................................../
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style={styles.leftText} colSpan={6}>
                  Шилжилтийн бүс  Шилжилтийн бүс 1  Шилжилтийн бүс 2 
                  Шилжилтийн бүс 3
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style={styles.leftText} colSpan={6}>
                  Эдийн шинжилгээ авах талбай сонгох боломжтой эсэх:  тийм 
                  үгүй
                </td>
              </tr>
              <tr>
                <td style={styles.leftText} colSpan={6}>
                  ...
                  <div style={styles.leftText}>
                    ӨОУА-10 ________________________________
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style={styles.leftText} colSpan={6}>
                  29. Хэрэв тийм бол умайн хүзүүний эдийн шинжилгээ хийх талаар
                  үйлчлүүлэгчид таниулж зөвшөөрөл авсан эмчийн нэр, гарын үсэг
                  /................................../............................................./
                </td>
              </tr>
              <tr>
                <td style={styles.leftText} colSpan={6}>
                  30. Умайн хүзүүний эдийн шинжилгээ хийлгэхийг зөвшөөрсөн
                  үйлчлүүлэгчийн нэр гарын үсэг
                  /...................................../......................................../
                </td>
              </tr>
              ...
              <tr>
                <td style={styles.leftText} colSpan={6}>
                  ...
                  <div style={styles.leftText}>
                    Эдийн шинжилгээний хариу хүлээн авсан огноо: _______ он ____
                    сар___өдөр
                  </div>
              ...
              <tr>
                ...
                <td
                  style={{ ...styles.centerText, ...{ width: 350 } }}
                  colSpan={2}
                >
                  ДЭМБ-ын ангилал
                </td>
                ...
                <td
                  style={{ ...styles.leftText, ...{ width: 350 } }}
                  colSpan={2}
                ></td>
              </tr>
              <tr>
      ...
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.leftText}>
            Төгсгөлийн онош:  Хэвийн  Үрэвсэлтэй  CIN1  CIN2-CIN3  Байран
            өмөн  Цөмлөн түрсэн өмөн (SCC)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            Арга хэмжээ авч эхэлсэн огноо: _______ он ____ сар___өдөр
          </div>
          <div style={styles.leftText}>35. Авсан арга хэмжээ:</div>
          <div style={styles.leftText}>
             Давтан шинжилгээ хийх  Дараагийн илрүүлэг үзлэгт хамрагдахыг
            зөвлөсөн
          </div>
          <div style={styles.leftText}>
             Шаардлагатай эмийн эмчилгээг зөвлөсөн  LEEP  Конизаци
          </div>
          <div style={styles.leftText}>
             ХСҮТ-д эмчилгээ хийлгэхийг зөвлөсөн  Давтан хамрагдалт
          </div>
          ...
          <div style={styles.leftText}>
            Заавар: Энэхүү маягтыг үзлэг хийсэн тухайн өдөрт нь Эргэн дуудах
            тогтолцооны програмд шивж оруулна. Давтан авсан эсийн болон эдийн
            шинжилгээний хариу гарсны дараа дүгнэлтээ гаргаж, үлдсэн асуултуудыг
            бүрэн бөглөсний дараа маягтыг програмд оруулан, цаасаар аймаг,
            дүүргийн статистикч (ХБА) эмчид илгээнэ..
          </div>
          <div style={styles.leftText}>
            Жич: Үйлчлүүлэгч өрх, сумын эрүүл мэндийн төвдөө үзүүлээгүй шууд
            эмэгтэйчүүдийн кабинетаар үйлчлүүлж, зөвхөн эсийн шинжилгээ авсан
            тохиолдолд ЭИМ-3- г хөтөлнө. -Түүнчэн төрөлжсөн мэргэжлийн төв,
            тусгай зөвшөөрөл бүхий хувийн хэвшлийн эмнэлгүүдэд эрт илрүүлэг
            үзлэг хийсэн хийсэн тохиолдолд эх барих эмэгтэйчүүдийн эмчийн хөтлөх
            маягтыг хөтөлж, Эргэн дуудах тогтолцооны програмд оруулан мэдээллийн
            сан үүсгэж , журмйн дагуу мэдээлнэ. Энэхү маягтын дагуу Эрт илрүүлэг
            эргэн дуудах тогтолцооны програм ажиллах бөгөөд тухай бүрд
            хөгжүүлэлт хийх болон заавар зөвлөмж өгөх ажлыг ХСҮТ-ийн Хавдрын
            бүртгэл тандалт эрт илрүүлгийн алба хариуцна.
          </div>
        </div>
      </div>
    </>
