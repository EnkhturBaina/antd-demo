      ...
      <div className="subpage-landscape">
        ...
        <Table bordered style={{ marginTop: 20 }}>
          <thead>
            ...
            >
              <td style={{ width: 300, textAlign: "center", fontSize: 12 }}>
              ...
              <td style={{ width: 100, textAlign: "center", fontSize: 12 }}>
                <span>Давтамж</span>
              </td>
              <td
                style={{
        ...
        <Table bordered style={{ marginTop: 20 }}>
          <thead>
            ...
            >
              ...
              <td style={{ width: 120, textAlign: "center", fontSize: 12 }}>
                <span>Эмчилгээний нэр</span>
              </td>
              <td style={{ width: 80, textAlign: "center", fontSize: 12 }}>
                <span>Ямар эрхтэнд</span>
