    ...
    <>
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.centerText}>
            Эцэг /эх/-ийн нэр _________________________________________
          </div>
        ...
        <div className="subpage">
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 90 }}>
              2.6 Төрөлжсөн нарийн мэргэжлийн эмнэлэг
            </span>
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>2.7 Төв эмнэлэг/Тусгай
            мэргэшлийн төв
          ...
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>гэрлэсэн,
            гэрлэсэн/тусдаа, салсан, бэлбэсэн, тодорхойгүй ___________________
          </div>
          <div style={styles.leftText}>
            6. Боловсрол: (зур) боловсролгүй, бага, дунд,
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>мэргэжлийн болон
            техникийн, дээд, тодорхойгүй ___________________
          </div>
          <div style={styles.leftText}>
            7. Нийгмийн байдал: ажилтай, ажилгүй, малчин, оюутан, сурагч, бусад
          </div>
          <div style={styles.leftText}>
            8. Эмнэлэгт хэвтсэн __________он __________сар _____өдөр__________
            цаг _____минут
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>хүндэвтэр, хүнд, маш
            хүнд, бусад ___________________
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            11. Биеийн жин ___________________________________________ кг
          </div>
          <div style={styles.leftText}>
            12. Өндөр ___________________________________________ см
          </div>
          <div style={styles.leftText}>
            13. Цусны даралт: б ___________________ з ___________________
            судасны цохилтын тоо _________
          </div>
      ...
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Хожуу үеийн
            зулбалт(халдварлагдсан,халдварлагдаагүйг зурах)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Төрөөгүй (жирэмсэн
            үргэлжлэн тээгдэж буй)
          </div>
          <div style={styles.leftText}>
            19. Өмнөх жирэмсэн, төрөлт, төрсний дараа болон үр хөндөлттэй
            холбоотой
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>ямар нэгэн хүндрэл
            байсан уу?
            <span style={{ marginLeft: 128 }}>1. тийм</span>
            <span style={{ marginLeft: 30 }}>2. үгүй</span>
          </div>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Улаанбаатар хот,
            ЭХЭМҮТ
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>23.2
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Улаанбаатар хот, Эрүүл
            мэндийн нэгдэл
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Аймаг сумын Өрхийн
            Эрүүл мэндийн төв
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>эрүүл мэндийн хичээл
            сургалтанд оролцсон эсэх:
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Халдварт ба шимэгчит
            зарим өвчин
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Цус, цус бүтээх
            эрхтний өвчин
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>26.5
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Дотоод шүүрэл,
            тэжээлийн ба бодисын солилцооны өвчин
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>26.6
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Мэдрэлийн тогтолцооны
            өвчин
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>26.7
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Цусны эргэлтийн
            тогтолцооны өвчин
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>26.8
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Амьсгалын тогтолцооны
            өвчин
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>26.9
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Хоол шингээх
            тогтолцооны өвчин
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>26.10
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Шээс, бэлгэсийн
            тогтолцооны өвчин
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>26.11
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Бусад
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Хожуу хордлогын хөнгөн
            хэлбэр (манас таталтын урьдлын)
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>27.4
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Хожуу хордлогын хүнд
            хэлбэр (манас таталтын урьдлын)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Судсанд цус түгээмлээр
            бүлэгнэх хам шинж
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Хэвийн байрласан ихэс
            цагаас урьтаж ховхрох
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>27.10
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Ураг орчмын шингэний
            ихдэлт
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Ургийн эмгэг (бүтэлт,
            өсөлтийн саатал)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Төрөлжсөн нарийн
            мэргэжлийн эмнэлэгт
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>28.2
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Төв эмнэлэг/Тусгай
            мэргэшлийн төв
          </div>
          <div style={styles.leftText}>
      ...
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Бусад
            _______________________________
          </div>
          <div style={styles.leftText}>30. Төрөлт удирдсан хүн:</div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>30.1
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Эх барих
            эмэгтэйчүүдийн мэргэжлийн эмч
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Төрөлтөнд оролцсон
            хүнгүй
          </div>
          <div style={styles.leftText}>
            31. Эхийн жирэмсний хугацаа (долоо хоногоор): _______________
          </div>
          ...
          <div style={styles.leftText}>
            ...
            (халдварлагдсан,халдварлагдаагүйг зурах)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>өдөр
            (зур):______он____сар____өдөр
          </div>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Эмийн аргаар үр
            хөндүүлэх
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>37.2
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Умайн хөндийгөөс
            соруулах
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Үр хөндөлтийн үеийн
            хүндрэл
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Цус алдалт (умайн
            агшилт суларснаас)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Умайн тулгамдсан
            урагдал
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Ургийн талын заалттай
            бол бичнэ үү (________________)
          </div>
          <div style={styles.leftText}>
      ...
      <div className="page">
        <div className="subpage">
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Умайн хөндийг гараар
            шалгах
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>40.3
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Умайн хөндийг багажаар
            шалгах
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>40.4
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Төрөх замын зөөлөн
            эдийн урагдал оёх
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Кесар хагалгааг
            өргөтгөн, умайг үтрээн дээгүүр авах хагалгаа
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>40.10
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Кесар хагалгааг
            өргөтгөн, умайг бүхэлд нь авах хагалгаа
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>40.11
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Кесар хагалгааг
            өргөтгөн хийгдсэн умайг тайрах/авах хагалгааны заалт
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>40.12
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Давтан хийгдсэн
            хагалгааны нэр
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>40.13
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Давтан хийгдсэн
            хагалгааны заалтыг бичих
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>40.14
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Давтан хагалгаа
            хийгдсэн _______он_____сар_____өдөр
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>40.15
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Умайн гадуурх
            жирэмсний улмаас хийгдсэн хагалгаа, нэр ______________________
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            42. Алдсан цусны хэмжээ (мл-р): _____________
          </div>
          <div style={styles.leftText}>
            43. Юүлсэн цусны хэмжээ (мл-р): _____________
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Үр хөндөлтийн улмаас
            цус алдсан
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Төрсний дараах цус
            алдалт
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>46.10
            <span style={{ marginLeft: 15 }}>&nbsp;</span>Эх барихын бусад цус
            алдалт
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Үр хөндөлттэй
            холбоотой
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>47.2
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Төрөх үеийн умайн
            салстын үрэвсэл
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>47.3
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Ургийн шингэн цагаас
            өмнө гарч халдварлагдах
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>47.4
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Кесар хагалгааны
            дараах халдвар
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>47.5
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Умайн хөндийг
            цэвэрлэснээс үүдэлтэй халдвар
          </div>
          <div style={styles.leftText}>
      ...
      <div className="page">
        <div className="subpage">
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Бусад системийн
            халдвар үрэвсэл/үжил
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Шок (зүрх судасны хурц
            дутагдал)
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>49.2
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Судас нарийсгагч эм
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Хүнд хэлбэрийн
            гипоперфузи(лактат&#62;5 ммоль/л эсвэл 45мг/дл)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Зүрх, уушгины
            амилуулалт
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Таталдсан амьсгал
            (үхлийн өмнөх амьсгал)
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>50.3
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Амьсгал хэт олшрох
            (амьсгал нэг минутанд &#62;40 олон)
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>50.4
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Амьсгал хэт цөөрөх
            (амьсгал нэг минутанд &#60;6 цөөн)
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>50.5
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Хүнд хэлбэрийн
            гипоксеми (PаO2/FiO2&#60;200 эсвэл О2-ийн ханамж
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 60 }}>&nbsp;</span>60 минутаас дээш
            хугацаанд 90%-с бага байх)
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>50.6
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Мэдээгүйжүүлэгтэй
            холбоогүйгээр цагаан мөгөөрсөн хоолойд
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 60 }}>&nbsp;</span>гуурс тавьж
            амьсгалуулах
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Шингэн сэлбэлт эсвэл
            шээс хөөх эмчилгээнд үр дүнгүй шээс багасах
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>51.2
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Бөөрний цочмог
            дутагдлын үед диалез хийсэн
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>51.3
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Цочмог хүнд хэлбэрийн
            азотеми
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 60 }}>&nbsp;</span>(креатинин&#62;300
            ммоль/мл эсвэл 3.5 мг/дл буюу түүнээс их)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Цус эсвэл улаан эс их
            хэмжээгээр сэлбэх (5нэгжээс дээш)
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>52.3
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Цочмог,хүнд хэлбэрийн
            ялтсын цөөрөл(50.000 ялтас/мл-с бага)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Манас таталтын
            урьдалтай үед шарлах
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>53.2
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Цочмог, хүнд хэлбэрийн
            хурц гипербилирубинеми
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 60 }}>&nbsp;</span>(билирубин&#62;100
            ммоль/л-ээс 6.0 мг/дл-с их)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Удаан хугацаагаар
            ухаангүй байх
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 60 }}>&nbsp;</span>(12 цаг болон түүнээс
            дээш хугацаагаар үргэлжилсэн дугжраа)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            ...
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Эпилепсийн
            байдал/хянаж чадахгүй байгаа таталт
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>54.4
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Бүтэн саажилт
            (тархмал)
          </div>
          <div style={styles.leftText}>55. Умайн үйл ажиллагааны алдагдал</div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>55.1
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Умайг авахад хүргэсэн
            цус алдалт эсвэл халдвар:
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            59. Эмнэлгээс гарсан, шилжсэн, нас барсан _________он _______сар
            ______өдөр
          </div>
          <div style={styles.leftText}>
            60. Ор хоног: _________хоног _________цаг _________минут
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            <span style={{ marginLeft: 30 }}>&nbsp;</span>Эмгэг судлалын
            шинжилгээний онош (ӨОУА-10 кодлох)
          </div>
          <div style={styles.leftText}>
            <span style={{ marginLeft: 20 }}>&nbsp;</span>Үндсэн онош:
            ____________________________________________________________________________
      ...
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.leftText}>
            <span style={{ marginLeft: 30 }}>&nbsp;</span>Ихэс, умай, дайврыг
            гистологи шинжилгээнд илгээсэн эсэх
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            64. Тохироогүй бол: 1. Үндсэн оношоор 2. Дагалдах оношоор 3.
            Хүндрэлээр (зур)
          </div>
          ...
          <div style={styles.leftText}>
            <span style={{ marginLeft: 30 }}>
              ...
              <span style={{ marginLeft: 30 }}>
                _______он _____сар _____өдөр _____цаг _____минут
              </span>
            </span>
          </div>
          <div style={styles.leftText}>
