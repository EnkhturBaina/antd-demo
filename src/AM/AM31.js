    ...
    <>
        ...
        <div className="subpage">
          ...
          <div style={styles.rowStyle}>
            ...
            <span style={{ marginLeft: 30 }}>
              Аймаг/хот: __________________________
            </span>
            <span style={{ marginLeft: 30 }}>
              Сум/дүүрэг: __________________________
            </span>
          </div>
          <div style={styles.rowStyle}>
          ...
          <div style={styles.rowStyle}>
            <b>Мэдээлсэн огноо:</b>
            <span style={{ marginLeft: 30 }}>
              ______он ____сар ____өдөр ____цаг ____минут
            </span>
          </div>
          <div style={styles.rowStyle}>
          ...
          <div style={styles.rowStyle}>
            1. Эцэг /эх/-ийн нэр: ____________________________
          </div>
          <div style={styles.rowStyle}>
            2. Хүүхдийн нэр: ____________________________
          </div>
          <div
            style={{
              ...styles.rowStyle,
          ...
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 150 }}>
              Сум/дүүрэг: __________________________________
            </span>
          </div>
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 150 }}>
              Баг/хороо: ___________________________________
            </span>
          </div>
          <div style={styles.rowStyle}>
            5. Эхийн боловсрол:
          ...
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 80 }}>
              1. Засгийн газраас тогтоосон амьжиргааны баталгаажих түвшнээс
            </span>
          </div>
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 80 }}>
              доогуур амьдралтай, орлого багатай, ажил эрхлээгүй
            </span>
          </div>
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 80 }}>
          ...
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 80 }}>
              5. Бусад ___________________________
            </span>
          </div>
          <div style={styles.rowStyle}>
          ...
          <div style={styles.rowStyle}>
            15. Амьдралын эхний 6 сарын дотор хүүхдийг дан хөхний сүүгээр
            хооллосон уу?
          </div>
          <div style={styles.rowStyle}>
          ...
          <div style={styles.rowStyle}>
            19. Дархлаажуулалтад хамрагдсан байдал (дархлаажуулалт хийгдсэн бол
            чагтална уу):
          </div>
          <div style={styles.rowStyle}>
          ...
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 50 }}>
              • УГУ (улаанууд, гахайн хавдар, улаанбурхан) вакцин
            </span>
            <span style={{ marginLeft: 70 }}>□ 1 тун</span>
            <span style={{ marginLeft: 50 }}>□ 2 тун</span>
          </div>
          ...
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 50 }}>
              • Бусад ____________________________________
            </span>
          </div>
        </div>
      </div>
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.rowStyle}>
            21. Хүүхэд эндэхээс хэд хоногийн өмнө дараах шинж тэмдгүүдээс илэрч
            байсан эсэхийг сонгоно уу
          </div>
          ...
          <div style={styles.rowStyle}>
            26. Хүүхдийг энэ өвчний үед нэг эмнэлгээс нөгөө эмнэлэг рүү
            шилжүүлсэн эсэх?
          </div>
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 30 }}>1. Тийм; 2. Үгүй</span>
          ...
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 30 }}>
              2. 1-р шатлал (сум/өрх)→3-р шатлал (төв эмнэлэг, төрөлжсөн нарийн
              мэргэжлийн эмнэлэг)
            </span>
          </div>
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 30 }}>
              3. 2-р шатлал (аймаг/дүүрэг)→3-р шатлал (төв эмнэлэг, төрөлжсөн
              нарийн мэргэжлийн эмнэлэг)
            </span>
          </div>
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 30 }}>
              4. 3-р шатлал (төв эмнэлэг, төрөлжсөн нарийн мэргэжлийн
              эмнэлэг)→1-р шатлал (сум/өрх) / 2-р шатлал (аймаг/дүүрэг)
            </span>
          </div>
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 30 }}>
          ...
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 30 }}>
              6. Бусад ___________________________
            </span>
          </div>
          <div style={styles.rowStyle}>
      ...
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.rowStyle}>
            <span style={{ marginLeft: 30 }}>
              16. Бусад ___________________________
            </span>
          </div>
          <div
            style={{
          ...
          <div style={{ marginLeft: 30 }}>
            ...
            <div style={styles.leftText}>
              <span style={{ marginLeft: 20 }}>&nbsp;</span>Дагалдах онош (суурь
              өвчин байсан бол дурдана уу):
          ...
          <div style={styles.rowStyle}>
            ...
            тусламж хайгаагүй эмнэлэгт хожуу үзүүлсэн)
          </div>
          <div style={styles.leftText}>
          ...
          <div style={styles.leftText}>
            • 3-р хожимдол (тоног төхөөрөмж, эм тарианы дутагдал, эмчийн ур
            чадвар сул байх, эмчилгээний тактик буруу, эмчилгээг оройтож
            эхэлсэн)
          </div>
          <div style={styles.leftText}>
            _________________________________________________________________________________________________________________________
