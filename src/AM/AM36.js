    ...
    <>
        ...
        <div className="subpage">
          ...
          >
            <div style={styles.leftBold}>
              Эмнэлгийн нэр: ______________________
            </div>
            <div
              style={{
                display: "flex",
          ...
          >
            <span style={{ fontWeight: "bold", fontSize: 16 }}>
              БҮХ НИЙТЭЭР ТЭМДЭГЛЭХ БАЯР, ТЭМДЭГЛЭЛТ ӨДРИЙН АМРАЛТЫН ҮЕИЙН
              ЭМНЭЛГИЙН ТУСЛАМЖ, ҮЙЛЧИЛГЭЭГ МЭДЭЭЛЭХ БҮРТГЭЛ
            </span>
          </div>
          <Table
            bordered
          ...
          >
            <tbody>
              ...
              <tr>
                ...
                <td
                  rowSpan={5}
                  style={{ ...styles.verticalText, ...{ width: 100 } }}
                >
                  Үүнээс
                </td>
              ...
              <tr>
                ...
                <td rowSpan={19} style={styles.centerText}>
                  Хүлээн авах, яаралтай тусламжийн тасгаар үйлчлүүлсэн иргэдийн
                  тоо
                </td>
      ...
      <div className="page">
        <div className="subpage">
          ...
          <div style={styles.leftBold}>
            Мөрийн дагуу: 9= (10+11+12+13+14+15)
          </div>
        </div>
      </div>
    </>
