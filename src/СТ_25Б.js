    ...
    <div className="page-landscape">
      <div className="subpage-landscape">
        <div>
          ...
          >
            <span style={{ fontSize: 11 }}>
              Эмчийн нэр: ___________________________________
            </span>
          </div>
          <div
            style={{
        ...
        <Table bordered className="document">
          <tbody>
            <tr>
              ...
              <td colSpan={9} style={textStyle.centerText}>
                Насны ангилал
              </td>
            </tr>
            <tr>
              ...
              <td style={textStyle.verticalText}>0-28 хоног</td>
              <td style={textStyle.verticalText}>29 хоногоос-1 нас</td>
              <td style={textStyle.verticalText}>1-2 нас</td>
              <td style={textStyle.verticalText}>2-3 нас</td>
              <td style={textStyle.verticalText}>3-4 нас</td>
              <td style={textStyle.verticalText}>4-5 нас</td>
              <td style={textStyle.verticalText}>6-9 нас</td>
              <td style={textStyle.verticalText}>10-13 нас</td>
              <td style={textStyle.verticalText}>14-15 нас</td>
            </tr>
            {[...Array(25)].map((x, j) => (
              <tr key={j}>
                {[...Array(38)].map((x, i) => (
